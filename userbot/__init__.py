...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```Hallo... ⚡N F Y  -  U S E R B O T⚡ Has Been Active!!```")
    return
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("⚡N F Y  -  U S E R B O T⚡, Buat Userbot Mu Sendiri [Tekan Disini](https://vckyou.github.io/Geez-UserBot)")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "Bantuan Dari ╡⚡N F Y  -  U S E R B O T⚡╞ ",
                    text="Daftar Modul",
                    buttons=[],
                    link_preview=True)
            else:
                result = builder.article(
                    " ╡⚡N F Y  -  U S E R B O T⚡╞ ",
                    text="""**Anda Bisa Membuat ⚡N F Y  -  U S E R B O T⚡ Anda Sendiri Dengan Cara :** __Tekan Dibawah Ini__ 👇""",
                    buttons=[
                        [
                            custom.Button.url(
                                "⚡𝗚𝗲𝗲𝘇",
                                "https://github.com/piknfy/Nfy-UserBot"),
                            custom.Button.url(
                                "✨𝗢𝘄𝗻𝗲𝗿",
                                "t.me/piknfy")]],
                    link_preview=False,
